package com.timerchina.collaborative.similarity.naive;

import util.ValueToIndexMapping;
...
import com.timerchina.collaborative.similarity.util.CosineSimilarityMeasure;
